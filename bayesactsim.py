...
for trial in range(num_trials):
    ...
    for exper in range(num_experiments):
        ...
        for iter in range(max_horizon):
            ...
            learn_avgs=learn_agent.propagate_forward(learn_aab,learn_observ,learn_xobserv,verb=learn_verbose)
            simul_avgs=simul_agent.propagate_forward(simul_aab,simul_observ,simul_xobserv,verb=simul_verbose)
